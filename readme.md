...
## 在原有基础上对IP-CIDR添加no-resolve 以避免不必要的DNS解析
### 试更新公告
...
**正在使用手机浏览本页面的用户 [请点击这里](https://harryzl.github.io/Shadowrocket-ADBlock-Rules-Forever) ，查看完整的说明文档。**
...
![规则选择指南](https://harryzl.github.io/Shadowrocket-ADBlock-Rules-Forever/figure/guide.png)
